...
void Meeting::generateAttendingURL()
{
    ...
    query_string="join"+find_str.full_name+"="+user_name+"&"+find_str.meeting_id+"="+meeting_data_.meeting_id+"&password="+meeting_data_.moderator_pw+"&redirect=true"+share_serect;
